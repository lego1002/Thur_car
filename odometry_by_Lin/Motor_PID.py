...
class PIDController:
    ...
    def update(self, feedback_value):
        ...
        self.integral = Helper.bound(self.output_min, self.output_max, self.integral)  #-> can be replace by lerp
        ...
        self.output = Helper.lerp(self.output_min, self.output_max, output)
